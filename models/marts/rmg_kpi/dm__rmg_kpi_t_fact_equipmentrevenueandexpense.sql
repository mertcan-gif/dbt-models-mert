...
SELECT 
	...
	equi.eqart AS object_type,
	equipment_group = '',
	main_cte.*
FROM main_cte
LEFT JOIN (
	SELECT DISTINCT equnr, eqart
	FROM {{ source('stg_s4_odata', 'raw__s4hana_t_sap_equi') }} WHERE eqtyp = 'T') equi ON main_cte.financial_center_code = equi.equnr
