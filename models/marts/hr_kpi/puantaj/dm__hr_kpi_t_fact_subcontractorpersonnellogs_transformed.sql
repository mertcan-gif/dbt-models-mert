...
,CASE 
  WHEN dim.main_discipline = N'DESTEK EMANET İŞÇILIK – ÖZBEK' THEN N'DESTEK-EMANET İŞÇILIK'
  WHEN dim.main_discipline = N'DESTEK RCT/RHB -ÖZBEK' THEN N'DESTEK-RCT/RHB'
  WHEN dim.main_discipline = N'DESTEK-NORMAL -ÖZBEK' THEN N'DESTEK-NORMAL'
  ELSE dim.main_discipline
END AS dim_main_discipline
,fact.[sub_discipline]
,fact.[collar_type]
,fact.[working_date]
,fact.[time]
