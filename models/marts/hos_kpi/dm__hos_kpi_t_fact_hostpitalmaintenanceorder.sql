{{
  config(
    materialized = 'table',tags = ['hos_kpi','rmore']
    )
}}

/* 
Date: 20250929
Creator: Ayşegül Yaren
Report Owner: Yılmaz Karamanoğlu
Explanation:Bu sorguda  RGY şirketinin arıza sipariş detaylarını görmek amaçlanmıştır. aufk.werks filtresi LIKE C olarak güncellendi ve hos_kpi altına kopyalandı.
*/
with finals as(
SELECT 
...
WHERE 1=1
	AND aufk.werks LIKE 'C%'
	AND aufk.AUART IN ('ZPM1','ZPM2')
)
