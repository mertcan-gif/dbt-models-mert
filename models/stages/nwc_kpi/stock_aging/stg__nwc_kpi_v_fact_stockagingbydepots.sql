...
WITH raw_data AS (
	SELECT 
		...
		,business_area = CASE 
						...
						ELSE werks END
		,business_area_description = CASE 
		...
		,[quantity_90_180] = CAST(MIKTAR_30_90 AS DECIMAL(18,5))
		,[amount_90_180] = CASE
