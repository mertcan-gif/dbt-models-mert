...
SELECT 
    ...
    ,NONSAP = 'S'
    ,RBUKRS = yb.[company]
    ,RACCT = CONVERT(NVARCHAR, CAST(yb.[general_ledger_account] AS DECIMAL(20,0)))
    ,TXT20 = ''
    ,TXT50 = ''
    ...
    ,deposit_demand_group = 'Yuvam'
FROM {{ ref('stg__nwc_kpi_t_fact_yuvamaccounts') }} as yb
