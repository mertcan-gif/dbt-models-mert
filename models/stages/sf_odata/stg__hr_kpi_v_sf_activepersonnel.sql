...
SELECT [seq_number]
      ...
      ,[second_manager_name] = CASE WHEN [second_manager_name] = 'None' THEN '' ELSE [second_manager_name] END
      ...
      ,[job_level]
      ,[functional_manager_name] = CASE WHEN [functional_manager_name] = 'None' THEN '' ELSE [functional_manager_name] END
...
where 1=1
	and [user_id] not in ('GLB10140','7088') -- Ozan Bey'in isteği üzerine filtredeki userID kaldırılmıştır. 
  and [global_id] <> ''