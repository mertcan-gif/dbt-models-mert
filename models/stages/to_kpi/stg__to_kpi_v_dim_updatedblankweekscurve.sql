...
WITH sorted_cte AS(
/*
Bu cte S-Curve tablosunun (project_id bazında),
...
*/
	...
	FROM {{source('stg_to_kpi','raw__to_kpi_t_fact_scurve')}}   
),

projects_with_current_report AS (
/*
Bu cte S-Curve tablosunda veri eksiği bulunmayan project_id'leri gösterir
*/
...
/*
Bu cte S-Curve tablosunda, bir önceki hafta verisi basılmamış olan project_id'leri gösterir
*/
	SELECT 
		DISTINCT project_id 
	FROM {{source('stg_to_kpi','raw__to_kpi_t_fact_scurve')}}
