...
WITH sorted_cte AS(
/*
Bu cte HseDetails tablosunun (project_id bazında),
...
*/
	...
	FROM {{source('stg_to_kpi','raw__to_kpi_t_fact_hsedetails')}}         
),

projects_with_current_report AS (
/*
Bu cte HseDetails tablosunda veri eksiği bulunmayan project_id'leri gösterir
*/
...
/*
Bu cte HseDetails tablosunda, bir önceki hafta verisi basılmamış olan project_id'leri gösterir
*/
	SELECT 
		DISTINCT project_id 
	FROM {{source('stg_to_kpi','raw__to_kpi_t_fact_hsedetails')}} 
