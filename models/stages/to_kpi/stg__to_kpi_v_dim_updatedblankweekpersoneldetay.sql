...
WITH sorted_cte AS(
/*
Bu cte Personel Detay tablosunun (project_id bazında),
...
/*
Bu cte Personel Detay tablosunda veri eksiği bulunmayan project_id'leri gösterir
*/
...
/*
Bu cte Personel Detay tablosunda, bir önceki hafta verisi basılmamış olan project_id'leri gösterir
*/
	SELECT 
		DISTINCT project_id 
	FROM {{source('stg_to_kpi','raw__to_kpi_t_fact_personeldetay')}}
