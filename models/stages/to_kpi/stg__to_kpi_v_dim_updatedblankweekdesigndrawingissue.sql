...
WITH sorted_cte AS(
/*
Bu cte DesignDrawingIssue tablosunun (project_id bazında),
...
*/
	...
	FROM {{source('stg_to_kpi','raw__to_kpi_t_fact_designdrawingissue')}}   
),

projects_with_current_report AS (
/*
Bu cte DesignDrawingIssue tablosunda veri eksiği bulunmayan project_id'leri gösterir
*/
...
/*
Bu cte DesignDrawingIssue tablosunda, bir önceki hafta verisi basılmamış olan project_id'leri gösterir
*/
	SELECT 
		DISTINCT project_id 
	FROM {{source('stg_to_kpi','raw__to_kpi_t_fact_designdrawingissue')}}
