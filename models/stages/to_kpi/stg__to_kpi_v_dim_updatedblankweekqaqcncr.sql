...
WITH sorted_cte AS(
/*
Bu cte QA_QC_NCR tablosunun (project_id bazında),
...
*/
	...
	FROM {{source('stg_to_kpi','raw__to_kpi_t_fact_qaqcncr')}}   
),

projects_with_current_report AS (
/*
Bu cte QA_QC_NCR tablosunda veri eksiği bulunmayan project_id'leri gösterir
*/
...
/*
Bu cte QA_QC_NCR tablosunda, bir önceki hafta verisi basılmamış olan project_id'leri gösterir
*/
	SELECT 
		DISTINCT project_id 
	FROM {{source('stg_to_kpi','raw__to_kpi_t_fact_qaqcncr')}} 
